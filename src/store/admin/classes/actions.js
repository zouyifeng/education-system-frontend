...
export default {
    addClasses({ commit }, classes) {
        const url = '/api/admin/classes_add.action';
        return util.post({ url }, classes);
    },
    editClasses({ commit }, classes) {
        const url = '/api/admin/classes_edit.action';
        return util.post({ url }, classes);
    },
    fetchAdminClassesList({ commit }, data) {
        const url = '/api/admin/classes_list.action';
