    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline">
                ...
                <button type="submit" class="btn btn-default" v-on:click="searchTeacher">查询</button>
                <router-link to="/admin/editTeacher" class="btn btn-primary">新增</router-link>                    
            </form>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="(item, index) in data.list">
                        ...
                        <td>
                            <button type="button" class="btn btn-xs btn-default" v-on:click="deleteTeacher(item.id)">删除</button>
                            <router-link class="btn btn-xs btn-default" :to="{ name :'editTeacher', params: { id: item.id }}">编辑</router-link>
